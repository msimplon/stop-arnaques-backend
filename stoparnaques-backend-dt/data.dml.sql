...
INSERT INTO articles (title, subtitle, description, image_url, date_of_publication, category_id) 
	VALUES
('Ecommerce','Tuto d√©scryptage fiabilit√© du site marchand','Lorem ipsum','assets/IMG/ampoule/conseils1.png','2022-05-19', (select c.id FROM categories c where c.name = 'Actualit√©s')),
('Les r√©seaux sociaux','contrefacon','Lorem ipsum blabla','assets/IMG/ampoule/conseils1.png','2022-03-29', (select c.id FROM categories c where c.name = 'Actualit√©s')),
('Influenceur et justice', 'Des influenceurs dans le collimateur de la justice!','Lorem ipsum balbla.','assets/IMG/ampoule/conseils1.png','2022-03-13', (select c.id FROM categories c where c.name = 'Actualit√©s')),
('Nos conseils √† suivre', 'Nos 10 conseils', 'Lorem ipsum','assets/IMG/ampoule/conseils1.png','2022-01-13',(select c.id FROM categories c where c.name = 'Conseils')),
('Notre lettre de r√©clamation', 'Lettre marchandise non conforme','Lorem ipsum balbla','assets/IMG/ampoule/conseils1.png','2022-03-13',(select c.id FROM categories c where c.name = 'Conseils')),
('Sept ans de prison pour un ex-influenceur','Detournement de fonds publics', 'Lorem ipsum balbla', 'assets/IMG/ampoule/conseils1.png','2022-03-13',(select c.id FROM categories c where c.name = 'Actualit√©s')),
('Obtenez rÈpÈratation','Lettre non livraison','Lorem ipsum','assets/IMG/ampoule/conseils1.png','2022-10-13', (select c.id FROM categories c where c.name = 'Conseils'));
...
INSERT INTO users (username, password)
	...
	/* crÈer l'utilisateur admin = 1 seul role admin mais ajout de plusieurs roles dans un future proche*
	 * mot de passe est diffÈrent du token, le token est un jeton unique pr un utilisateur qui lui permet...  */
    
INSERT INTO roles (name) 
	values ('ROLE_ADMIN');

	/* crÈer utilisateur admin test */
